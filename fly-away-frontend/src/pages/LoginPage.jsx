...
const LoginPage = () => {
  ...
  // Si ya estamos autenticados, redirigimos a /flights (evita que un usuario logueado vea el login)
  useEffect(() => {
    if (token) {
      navigate('/flights');
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // login ya hace navigate('/flights'), así que no necesitamos hacerlo aquí
      setLoading(false);
    } catch (err) {
      setLoading(false);
